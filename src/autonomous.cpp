...
#include "skid_steer_drive_through_point.hpp"
...
//void drive_through_point(std::shared_ptr<ChassisController> chassis, QLength y_target, double y_max_speed, double y_min_speed, QLength x_target, double x_max_speed, double x_min_speed, double drive_straight_kp, double y_drive_kp, double x_drive_kp,  double turn_min_speed, bool drive_straight);
// drive_through_point(chassis, 10_in, 100, 20, 0_in, 100, 10, 0.002, 1.0, 1.0, 0.12);
// //drive_through_point(chassis, 20_in, 100, 20, 0_in, 100, 10, 0.002, 1.0, 1.0, 0.12);
// intake_on(200);
//
//
// drive_through_point(chassis, 20_in, 100, 20, 0_in, 100, 10, 0.012, 1.0, 1.0, 0.12);
// //drive_through_point(chassis, 35_in, 100, 20, 0_in, 100, 10, 0.012, 1.0, 1.0, 0.12);
//
//
// drive_through_point(chassis, 55_in, 100, 20, -13_in, 100, 10, 0.002, 1.0, 1.0, 0.1);
//
//
// //drive_through_point(chassis, 65_in, 100, 20, -30_in, 100, 10, 0.012, 1.0, 1.0, 0.12);
//
//
// async_drive_to_point(chassis, 65_in, 100.0, 20.0, -45_in, 100.0, 30.0, -90, 0.012, 0.05, 0.07, 0.12);
// wait_for_drive_complete_2();
// intake_off();


//void skid_steer_drive_through_point(std::shared_ptr<ChassisController> chassis, QLength y_target, QLength x_target, double max_speed, double drive_straight_kp);
// intake_on(200);
// skid_steer_drive_through_point(chassis, 10_in, 0_in, 100, 0.04);
//
// skid_steer_drive_through_point(chassis, 20_in, 0_in, 100, 0.04);
//
// skid_steer_drive_through_point(chassis, 37_in, 0_in, 75, 0.04);
//
// skid_steer_drive_through_point(chassis, 61_in, -16_in, 50, 0.04);
//
// skid_steer_drive_through_point(chassis, 66_in, -35_in, 50, 0.04);
//
// skid_steer_drive_through_point(chassis, 66_in, -54_in, 50, 0.04);
//
// skid_steer_drive_through_point(chassis, 77_in, -67_in, 50, 0.04);
//
// async_drive_to_point(chassis, 90_in, 100.0, 20.0, -80_in, 100.0, 30.0, -45, 0.012, 0.05, 0.07, 0.12);
// wait_for_drive_complete_2();
// intake_off();
...
// intake_on(0);
//
// allowable_errors_up_adj(0.25, 0.15, 0.25);
// //async_drive_to_point(chassis, 36_in, 100.0, 20.0, 0_in, 100.0, 15.0, -25, 0.012, 0.05, 0.07, 0.12);//first ball
// async_drive_to_point(chassis, 34_in, 100.0, 10.0, 0_in, 100.0, 10.0, -25, 0.012, 0.05, 0.07, 0.12);//first ball
// wait_for_drive_complete_2();
//
// // pros::delay(200);
...
// //pros::delay(4000);
//
// allowable_errors_up_adj(1.5, 0.5, 0.5);
//
// async_drive_to_point(chassis, 17.8_in, 100.0, 20.0, -8.5_in, 100.0, 15.0, -43, 0.016, 0.05, 0.05, 0.12);
// intake_on(600);
// wait_for_drive_complete_2();
// intake_on(0);
//
...
//
// allowable_errors_up_adj(1.5, 1.0, 0.5);
//
// async_drive_to_point(chassis, -13_in, 100.0, 15.0, 40.3_in, 100.0, 25.0, 91, 0.02, 0.06, 0.07, 0.12);
// intake_on(-600);
// pros::delay(900);
// intake_on(0);
// intake_on(300);
...
// intake_on(0);
//
// allowable_errors_up_adj(3.0, 2.0, 0.5);
// maximum_vel_adj_up();
//
// async_drive_to_point(chassis, -27_in, 100.0, 20.0, 39.8_in, 100.0, 50.0, 90, 0.02, 0.1, 0.8, 0.12);
// wait_for_drive_complete_2();
//
// allowable_errors_back_3();
//
// async_drive_to_point(chassis, -27_in, 100.0, 15.0, 19_in, 100.0, 15.0, 90, 0.02, 0.05, 0.05, 0.12);
// intake_on(600);
// bottom_mtr.moveVelocity(-75);
// top_mtr.moveVelocity(75);
// wait_for_drive_complete_2();
// bottom_mtr.moveVelocity(0);
// top_mtr.moveVelocity(0);
// intake_on(0);
//
// async_drive_to_point(chassis, -95.5_in, 100.0, 15.0, 27_in, 100.0, 15.0, 149, 0.011, 0.05, 0.05, 0.12);//145.5
// intake_on(600);
// wait_for_drive_complete_2();
// intake_on(0);
//
...
// top_mtr.moveVelocity(0);
//
// allowable_errors_up_adj(3.0, 2.0, 2.0);
//
// async_drive_to_point(chassis, -84_in, 200.0, 20.0, -1_in, 200.0, 50.0, 230, 0.008, 0.05, 0.07, 0.12);
// pros::delay(500);
// intake_on(600);
// wait_for_drive_complete_2();
// intake_on(0);
//
// async_drive_to_point(chassis, -97.1_in, 200.0, 20.0, -18.4_in, 200.0, 50.0, 230, 0.009, 0.07, 0.05, 0.12);
// intake_on(600);
// wait_for_drive_complete_2();
// intake_on(0);
//
...
async_drive_to_point(chassis, -12_in, 100.0, 15.0, 40.3_in, 100.0, 25.0, 91, 0.02, 0.06, 0.07, 0.12);
intake_on(-600);
pros::delay(900);
intake_on(0);
intake_on(400);
...
async_drive_to_point(chassis, -27_in, 100.0, 15.0, 20_in, 100.0, 15.0, 90, 0.02, 0.05, 0.05, 0.12);
intake_on(600);
bottom_mtr.moveVelocity(-75);
top_mtr.moveVelocity(75);
wait_for_drive_complete_2();
...
async_drive_to_point(chassis, -97_in, 100.0, 15.0, 29.4_in, 100.0, 15.0, 145.5, 0.012, 0.05, 0.05, 0.12);
intake_on(600);
wait_for_drive_complete_2();
intake_on(0);
...
async_drive_to_point(chassis, -84_in, 200.0, 20.0, -1_in, 200.0, 50.0, 230, 0.008, 0.07, 0.07, 0.12);
//intake_on(600);
wait_for_drive_complete_2();
//intake_on(0);
...
// async_drive_to_point(chassis, -84_in, 200.0, 20.0, -2_in, 200.0, 50.0, 230, 0.009, 0.07, 0.08, 0.12);
// intake_on(-200);
// top_mtr.moveVelocity(600);
// bottom_mtr.moveVelocity(-600);
// wait_for_drive_complete_2();
...
// top_and_bottom_off();
//
// async_drive_to_point(chassis, -9.5_in, 100.0, 15.0, 40.3_in, 100.0, 25.0, 90, 0.02, 0.05, 0.07, 0.12);
// intake_on(-200);
// pros::delay(900);
// intake_on(0);
// intake_on(200);
...
// // drive_to_point(chassis, 18_in, 100.0, 20.0, 0_in, 100.0, 15.0, 0, 0.009, 0.05, 0.07, 0.12);//first ball
// //skid_steer_drive_through_point(chassis, 8_in, 0_in, 50, 0.04);
// intake_on(200);
// intake_ball();
// wait_for_drive_complete_2();
// intake_on(0);
...
// allowable_errors_up();
//
// async_drive_to_point(chassis, 6.8_in, 100.0, 20.0, -21.5_in, 100.0, 15.0, -131, 0.018, 0.05, 0.04, 0.12);//first tower //former//X - (-21.5)//Y (6)
// wait_for_drive_complete_2();
// top_and_bottom_spin();
// intake_on(200);
// pros::delay(780);
...
// intake_off();
//
// async_drive_to_point(chassis, 62_in, 100.0, 20.0, -8.5_in, 100.0, 35.0, 13, 0.03, 0.06, 0.08, 0.12); //third ball
// intake_on(200);
// intake_ball();
// wait_for_drive_complete_2();
// intake_off();
...
// //Auto //X - (-20.2) //Y - (63.7)
//
// async_drive_to_point(chassis, 64.1_in, 100.0, 15.0, -21.5_in, 100.0, 15.0, -90, 0.017, 0.06, 0.05, 0.12);//second tower //former//X - (-20)//Y (64.75)
// wait_for_drive_complete_2();
// top_and_bottom_spin();
// intake_on(200);
// pros::delay(750);
...
// intake_on(-150);
// top_and_bottom_eject();
// async_drive_to_point(chassis, 63.5_in, 100.0, 20.0, -9_in, 100.0, 25.0, -110, 0.03, 0.04, 0.03, 0.12);//eject balls 2
// wait_for_drive_complete_2();
// top_and_bottom_off();
// intake_off();
//
// // async_drive_to_point(chassis, 63.5_in, 100.0, 15.0, -8_in, 100.0, 15.0, -45, 0.017, 0.06, 0.05, 0.12);//second tower //former//X - (-20)//Y (64.75)
// // wait_for_drive_complete_2();
//
// // intake_on(200);
// // skid_steer_drive_through_point(chassis, 90_in, -15_in, 50, 0.01);
// //skid_steer_drive_through_point(chassis, 93_in, -18_in, 50, 0.01);
// // skid_steer_drive_through_point(chassis, 99_in, -23.6_in, 50, 0.01);
//
// // async_drive_to_point(chassis, 98_in, 100.0, 10.0, -23_in, 100.0, 20.0, -57, 0.04, 0.06, 0.07, 0.2);//fourth ball
// // intake_on(200);
// // wait_for_drive_complete_2();
// // intake_off();
//
// async_drive_to_point(chassis, 98_in, 100.0, 10.0, -23_in, 100.0, 20.0, -57, 0.02, 0.06, 0.07, 0.2);//fourth ball
// intake_on(200);
// wait_for_drive_complete_2();
// intake_off();
//
...
// //Auto //X - () //Y -
//
// async_drive_to_point(chassis, 117.4_in, 100.0, 17.5, -19.5_in, 100.0, 40.0, -45, 0.012, 0.06, 0.1, 0.12);//align to third tower //former//X - (-18)//Y (119)
// intake_on(200);
// intake_ball();
// wait_for_drive_complete_2();
// intake_off();
...
// //Auto //X - (-22.2) //Y - (123.4)
//
// async_drive_to_point(chassis, 123.2_in, 100.0, 15.0, -25_in, 100.0, 20.0, -45, 0.012, 0.05, 0.06, 0.12);//third tower //former//X - (-22.5)//Y (123.5)
// wait_for_drive_complete_2();
// top_and_bottom_spin();
// intake_on(200);
// pros::delay(750);
...
// intake_off();
//
// async_drive_to_point(chassis, 85_in, 100.0, 20.0, 33.5_in, 100.0, 20.0, 137, 0.012, 0.04, 0.05, 0.12);//sixth ball
// intake_on(200);
// intake_ball();
// wait_for_drive_complete_2();
// intake_off();
...
// allowable_errors_up();
//
// async_drive_to_point(chassis, 118_in, 100.0, 15.0, 31.5_in, 100.0, 30.0, 0, 0.018, 0.06, 0.09, 0.12);//fourth tower //former//X - (36)//Y (122.5)
// intake_ball();
// wait_for_drive_complete_2();
// top_and_bottom_spin();
// intake_on(200);
...
// intake_off();
//
// async_drive_to_point(chassis, 99_in, 100.0, 20.0, 93.5_in, 100.0, 30.0, 90, 0.008, 0.05, 0.08, 0.12);//eighth ball
// intake_on(200);
// intake_ball();
// wait_for_drive_complete_2();
// intake_off();
...
// allowable_errors_up();
//
// async_drive_to_point(chassis, 116.2_in, 100.0, 20.0, 85.8_in, 100.0, 25.0, 45, 0.012, 0.15, 0.2, 0.12);//align to fifth tower
// wait_for_drive_complete_2();
//
// async_drive_to_point(chassis, 125.5_in, 100.0, 10.0, 91.35_in, 100.0, 25.0, 45, 0.012, 0.09, 0.07, 0.12); //fifth tower
// intake_ball();
// wait_for_drive_complete_2();
// top_and_bottom_spin();
// intake_on(200);
...
// allowable_errors_back();
//
// async_drive_to_point(chassis, 64_in, 100.0, 20.0, 53.5_in, 100.0, 25.0, 199, 0.012, 0.06, 0.1, 0.12);//ninth ball//0.03
// intake_on(-125);//200
// top_and_bottom_eject();
// pros::delay(800);
// intake_off();
...
// intake_off();
//
// async_drive_to_point(chassis, 65_in, 100.0, 15.0, 89.25_in, 100.0, 10.0, 90, 0.04, 0.03, 0.03, 0.12);//tenth ball and sixth tower
// intake_on(200);
// intake_ball();
// wait_for_drive_complete_2();
// intake_off();
...
// intake_off();
//
// // async_drive_to_point(chassis, 33_in, 100.0, 40.0, 92.5_in, 100.0, 60.0, 123, 0.04, 0.07, 0.15, 0.2);//eleventh ball
// // intake_on(200);
// // wait_for_drive_complete_2();
// // intake_off();
//
// async_drive_to_point(chassis, 33_in, 100.0, 40.0, 90.5_in, 100.0, 60.0, 123, 0.04, 0.07, 0.08, 0.2);//eleventh ball
// intake_on(200);
// wait_for_drive_complete_2();
// intake_off();
//
//
// async_drive_to_point(chassis, 10_in, 100.0, 20.0, 86.2_in, 100.0, 25.0, 123, 0.012, 0.05, 0.175, 0.12);//align to seventh tower
// intake_on(200);
// intake_ball();
// wait_for_drive_complete_2();
// intake_off();
//
// async_drive_to_point(chassis, 6_in, 100.0, 20.0, 92.6_in, 101.0, 25.0, 135, 0.012, 0.04, 0.1, 0.12);//seventh tower
// wait_for_drive_complete_2();
// top_and_bottom_spin();
// intake_on(200);
// pros::delay(750);
...
// intake_off();
//
// async_drive_to_point(chassis, 17_in, 100.0, 15.0, 92_in, 100.0, 35.0, 270, 0.012, 0.04, 0.06, 0.12);//descore seventh tower
// intake_on(-125);
// top_and_bottom_eject();
// wait_for_drive_complete_2();
// top_and_bottom_off();
...
// allowable_errors_up();
//
// async_drive_to_point(chassis, 8_in, 100.0, 20.0, 33.5_in, 100.0, 25.0, 180, 0.02, 0.04, 0.1, 0.12);//eighth tower
// intake_ball();
// wait_for_drive_complete_2();
// top_and_bottom_spin();
// intake_on(200);
...
//
// maximum_vel_adj_up();
// allowable_errors_up_adj(4.0, 1.0, 0.5);
//
// async_drive_to_point(chassis, 61_in, 100.0, 15.0, 16.5_in, 100.0, 25.0, 312, 0.012, 0.05, 0.04, 0.12);
// intake_on(200);
// intake_ball();
// wait_for_drive_complete_2();
// intake_off();
//
// async_drive_to_point(chassis, 58.5_in, 100.0, 15.0, 26.5_in, 100.0, 25.0, 450, 0.03, 0.04, 0.05, 0.12);
// intake_on(200);
// wait_for_drive_complete_2();
// intake_off();
//
// async_drive_to_point(chassis, 59_in, 100.0, 15.0, 20.95_in, 100.0, 25.0, 450, 0.012, 0.1, 0.09, 0.12);
// intake_on(200);
// wait_for_drive_complete_2();
// intake_off();
//
// async_drive_to_point(chassis, 59_in, 100.0, 15.0, 23.7_in, 100.0, 25.0, 450, 0.012, 0.1, 0.09, 0.12);
// intake_on(200);
// wait_for_drive_complete_2();
// intake_off();
//
...
// intake_off();
//
// async_drive_to_point(chassis, 59_in, 100.0, 15.0, 24.05_in, 100.0, 25.0, 450, 0.012, 0.1, 0.09, 0.12);
// intake_on(200);
// wait_for_drive_complete_2();
// intake_off();
//
...
// //Auto //X - () //Y -
//
// async_drive_to_point(chassis, 117.4_in, 100.0, 17.5, -19.5_in, 100.0, 30.0, -45, 0.012, 0.04, 0.1, 0.12);//align to third tower //former//X - (-18)//Y (119)
// intake_on(200);
// intake_ball();
// wait_for_drive_complete_2();
// intake_off();
...
// intake_off();
//
// async_drive_to_point(chassis, 86.5_in, 100.0, 20.0, 33.5_in, 100.0, 20.0, 137, 0.012, 0.04, 0.05, 0.12);//sixth ball
// intake_on(200);
// intake_ball();
// wait_for_drive_complete_2();
// intake_off();
...
// allowable_errors_up();
//
// async_drive_to_point(chassis, 118.5_in, 100.0, 20.0, 32_in, 100.0, 30.0, 0, 0.018, 0.06, 0.07, 0.12);//fourth tower //former//X - (36)//Y (122.5)
// intake_ball();
// wait_for_drive_complete_2();
// top_and_bottom_spin();
// intake_on(200);
...
// intake_off();
//
// async_drive_to_point(chassis, 98_in, 100.0, 20.0, 93.5_in, 100.0, 30.0, 90, 0.008, 0.05, 0.08, 0.12);//eighth ball
// intake_on(200);
// intake_ball();
// wait_for_drive_complete_2();
// intake_off();
...
// allowable_errors_back();
//
// async_drive_to_point(chassis, 64_in, 100.0, 20.0, 54.5_in, 100.0, 25.0, 199, 0.012, 0.06, 0.1, 0.12);//ninth ball//0.03
// intake_on(-125);//200
// top_and_bottom_eject();
// pros::delay(800);
// intake_off();
...
// intake_off();
//
// async_drive_to_point(chassis, 64.3_in, 100.0, 15.0, 89.25_in, 100.0, 10.0, 90, 0.04, 0.03, 0.03, 0.12);//tenth ball and sixth tower
// intake_on(200);
// intake_ball();
// wait_for_drive_complete_2();
// intake_off();
...
// intake_off();
//
// async_drive_to_point(chassis, 5_in, 100.0, 20.0, 93.1_in, 101.0, 25.0, 135, 0.012, 0.04, 0.1, 0.12);//seventh tower
// wait_for_drive_complete_2();
// top_and_bottom_spin();
// intake_on(200);
// pros::delay(750);
...
// intake_off();
//
// async_drive_to_point(chassis, 16_in, 100.0, 15.0, 92_in, 100.0, 35.0, 270, 0.012, 0.04, 0.06, 0.12);//descore seventh tower
// intake_on(-125);
// top_and_bottom_eject();
// wait_for_drive_complete_2();
// top_and_bottom_off();
...
// allowable_errors_up_adj(4.0, 1.0, 0.5);
//
// async_drive_to_point(chassis, 61_in, 100.0, 15.0, 16_in, 100.0, 25.0, 312, 0.012, 0.05, 0.04, 0.12);
// intake_on(200);
// intake_ball();
// wait_for_drive_complete_2();
// intake_off();
...
// intake_off();
//
// async_drive_to_point(chassis, 59_in, 100.0, 15.0, 24.2_in, 100.0, 25.0, 450, 0.012, 0.1, 0.09, 0.12);
// intake_on(200);
// wait_for_drive_complete_2();
// intake_off();
//
...
// intake_off();
//
// async_drive_to_point(chassis, 59_in, 100.0, 15.0, 24.55_in, 100.0, 25.0, 450, 0.012, 0.1, 0.09, 0.12);
// intake_on(200);
// wait_for_drive_complete_2();
// intake_off();
//
