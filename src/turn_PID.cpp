...
void gyro_turn(std::shared_ptr<ChassisController> chassis, QAngle angle, double max_speed, double min_speed, double kp, double ki, double kd, double epsilon)
{
...
void gyro_turn_to(std::shared_ptr<ChassisController> chassis, QAngle angle, double max_speed, double min_speed, double kp, double ki, double kd, double epsilon)
{
    ...
    gyro_turn(chassis, new_angle, max_speed, 17.5, kp, ki, kd, 2);
}
